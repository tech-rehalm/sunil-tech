    ...
    <div className='container mx-auto px-4 py-8'>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="stat bg-slate-900 shadow">
          ...
          <div className="stat-title text-gray-200">Total Products</div>
        ...
        <div className="stat bg-slate-900 shadow">
          ...
          <div className="stat-title text-gray-200">Total Orders</div>
        ...
        <div className="stat bg-slate-900 shadow">
          ...
          <div className="stat-title text-gray-200">Total Users</div>
        ...
        <div className="stat bg-slate-900 shadow">
          ...
          <div className="stat-title text-gray-200">Categories</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <div className="stat bg-slate-900 shadow">
          ...
          <div className="stat-title text-gray-200">Total Revenue</div>
        ...
        <div className="stat bg-slate-900 shadow">
          ...
          <div className="stat-title text-gray-200">Average Order Value</div>
        ...
        <div className="stat bg-slate-900 shadow">
          ...
          <div className="stat-title text-gray-200">Low Stock Items</div>
      ...
      <div className="card bg-slate-900 shadow-xl">
        <div className="card-body">
          ...
          <p className="text-sm font-semibold text-gray-300">&copy; SunilTech All Rights Reserved</p>
        </div>
      </div>
    </div>
  )
